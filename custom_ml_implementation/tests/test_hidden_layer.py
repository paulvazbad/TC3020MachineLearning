...
class TestHiddenLayer(unittest.TestCase):
    ...
    def test_z(self):
        ...
        self.assertEquals(len(self.hidden_layer.z(a)), self.hidden_layer.get_number_of_neurons())
        # Output is correct
        self.assertSequenceEqual(self.hidden_layer.z(a).tolist(),[4.0,4.0,4.0])
        print("Tests z of a hidden layer")

    def test_activation_function(self):
        a = np.arange(3)
        print(a)
        self.assertSequenceEqual(self.hidden_layer.activation_function(a), [0.9820137900379085, 0.9820137900379085, 0.9820137900379085])
